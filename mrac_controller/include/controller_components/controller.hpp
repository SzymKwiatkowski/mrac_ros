...
public:
    ...
    virtual void update_target(const geometry_msgs::msg::Pose::SharedPtr& _target_position);
    virtual void update_position(const geometry_msgs::msg::PoseStamped::SharedPtr& _current_position);
